        ...
        <div class="heading-layout1">
            ...
            <div class="dropdown show">
                <div class="col-12 form-group mg-t-8">
                    <a href="manage_exams"> <button type="submit"
                            class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark">Add new Exam</button>
                    </a>
                </div>
            </div>
        </div>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a class="dropdown-item"
                                        href="manage_exams?id=<?php echo $row['id']?>"><i
