        ...
        <div class="heading-layout1">
            ...
            <div class="dropdown show">
                <div class="col-12 form-group mg-t-8">
                    <a href="manage_class"> <button type="submit"
                            class="btn-fill-lg btn-gradient-yellow btn-hover-bluedark">Add new class</button>
                    </a>
                </div>
            </div>
        </div>
            ...
            <table class="table display data-table text-nowrap">
                ...
                <tbody id="myTable">
                    ...
                    <tr role="row" class="odd">
                        ...
                        <td class="sorting_1 dtr-control"><?php echo $row['apply_last_date']?></td>
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a class="dropdown-item"
                                        href="manage_class?id=<?php echo $row['id']?>"><i
