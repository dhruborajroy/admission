                     ...
                     <div class="row">
                        ...
                        <div class="col-lg-6">
                           <div class="form-group">
                              ...
                              <input disabled value="<?php echo $gender?>" class="form-control">
                           </div>
                        </div>
                        <div class="col-lg-6">
                           <div class="form-group">
                              <label class="form-control-label">Phone Number</label>
                              <input disabled value="<?php echo $phone_number?>" id="phone_number" class="form-control">
                           </div>
                        </div>
                        <div class="col-lg-6">
                           <div class="form-group">
                        ...
                        <div class="col-lg-6">
                           <div class="form-group">
                              ...
                              <input disabled type="number" autocomplete="off" name="birthID" id="birthID" value="<?php echo $birthId?>" class="form-control">
                           </div>
                        </div>
                     </div>
               </div>
