...
define('FRONT_SITE_PATH','https://getadmittedonline.thewebdivers.com/');
...
define('UPLOAD_APPLICANT_IMAGE',$_SERVER['DOCUMENT_ROOT']."/media/users/");
define('UPLOAD_STUDENT_IMAGE',$_SERVER['DOCUMENT_ROOT']."/media/users/");
